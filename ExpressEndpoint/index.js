...
// node index.js
// HTTP tunneling CMD:
// mac: autossh -M -0 -o ServerAliveInterval=60 -R MessengerAssistant1:80:localhost:1337 serveo.net
// windows: ssh -o ServerAliveInterval=60 -R MessengerAssistant1:80:localhost:1337 serveo.net
// alternative port forwarding: ngrok http 1337 (need to change gateway API everytime with this command)
